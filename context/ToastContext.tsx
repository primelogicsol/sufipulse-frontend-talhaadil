    ...
    <ToastContext.Provider value={{ showToast }}>
      ...
      {visible && (
        <div className="fixed bottom-6 right-6 z-50 animate-in slide-in-from-right-full duration-300">
          <div className="bg-white border-l-4 border-emerald-900 rounded-lg shadow-xl backdrop-blur-sm min-w-[320px] max-w-[400px] p-5 transform transition-all duration-300 ease-out hover:shadow-2xl hover:scale-[1.02]">
            <div className="flex items-start gap-3">
              ...
              <button
                onClick={hideToast}
                className="flex-shrink-0 p-1 rounded-full hover:bg-slate-800 transition-colors duration-200"
