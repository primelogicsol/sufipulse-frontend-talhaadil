  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-screen">
        <div className="text-slate-800 text-lg animate-pulse">Loading vocalists...</div>
      </div>
    )
  }
              ...
              <tr key={vocalist.id} className="border-t border-slate-200 hover:bg-slate-50">
                <td className="py-3 px-4 sm:px-6">
                  <div className="w-10 h-10 bg-emerald-900 rounded-full flex items-center justify-center">
                    <span className="text-emerald-50 font-semibold text-lg">{vocalist.name.charAt(0).toUpperCase()}</span>
                  </div>
                </td>
